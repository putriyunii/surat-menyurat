...
const AddSuratkeluar = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        if (!fData.get("nomor_surat") || !fData.get("tujuan") || !fData.get("pengirim") || !fData.get("perihal")) {
            Swal.fire({
                icon: "error",
                ...
                try {
                    ...
                    if (!response.ok) {
                        ...
                        Swal.fire({
                            ...
                            window.location.href = "/admin/suratkeluar";
                        });
                    }
                } catch (error) {
                    Swal.fire({
    ...
    return (
        <Container className="p-4">
            <h2 className="mb-4">Tambah Surat Keluar</h2>
            <Card>
                <Card.Header className="bg-white">
                    <Link to="/admin/suratkeluar" className="btn btn-primary">
                        Lihat Data
                    </Link>
                </Card.Header>
                <Card.Body>
                        ...
                        <Row className="mb-3">
                            <Col md={6}>
                                <Form.Group>
                                    ...
                                    <Form.Control type="text" name="tujuan" placeholder="Masukkan Tujuan" required />
                                </Form.Group>
                            </Col>
                            <Col md={6}>
                                <Form.Group>
